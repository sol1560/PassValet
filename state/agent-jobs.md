...
| 34980422186 | GitHub Actions | M5原生键盘和最小窗口 | done | 20项桌面及双架构包通过，两种启动截图已检查；watch进程263648已结束 |
| 34982392762 | GitHub Actions | M5小窗口日志列宽修复 | done | 20项桌面及双架构包通过；日志和两种启动截图已检查；两套下载包校验值均通过；watch进程265850已结束 |
| 34985298436 | GitHub Actions | M4采集权限指引修正 | done | 桌面20 passing (1m 58.3s)，双架构包通过；watch进程272732已结束 |
| 34987633820 | GitHub Actions | M4Cloudflare新格式及隐藏规则 | done | 桌面20 passing (1m 58.4s)，双架构包通过；最新截图已检查、下载包已校验；watch进程274649已结束 |
